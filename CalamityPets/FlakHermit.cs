    ...
    public sealed class FlakHermitEffect : PetEffect
    {
        ...
        public void AcidExplosion(Vector2 center)
        {
            foreach (NPC npc in Main.ActiveNPCs)
            {
                ...
                {
                    npc.SimpleStrikeNPC(Pet.PetDamage(acidBaseDmg), Player.direction, Main.rand.NextBool((int)Math.Min(Player.GetTotalCritChance<RogueDamageClass>(), 100), 100), 0, DamageClass.Throwing, true, Player.luck);
